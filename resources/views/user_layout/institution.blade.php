...
@section('user_layout')
    ...
    <section class="how_works how_works--bg-gray how_works--padding">
        <span class="shape-2"><img src="user_layout/images/how-works/big-shape.svg" alt="big-shape.svg"></span>
    ...
    <section class="photGallery photGallery--bottom">
        <img class="img-big" src="user_layout/images/how-works/connect-bg-big.svg" alt="photo-gallery-desk.png">
        <img class="img-sm" src="user_layout/images/how-works/connect-bg-sm.svg" alt="photo-gallery-smg">
        <div class="signup_btn">
            <button class="btn btn-yellow">Join for free</button>
        </div>
    </section>

    <!-- Possibilities -->
    <section class="posibilities">
        <span class="shape shape--1"> <img src="user_layout/images/posibilities/shape-line-1.svg" alt="shape-line-1"> </span>
        <span class="shape shape--2"> <img src="user_layout/images/posibilities/shape-line-2.svg" alt="shape-line-2"> </span>
        <span class="shape shape--3"> <img src="user_layout/images/posibilities/shape-line-3.svg" alt="shape-line-3"> </span>
        <span class="shape shape--4"> <img src="user_layout/images/posibilities/shape-line-4.svg" alt="shape-line-4"> </span>
        <span class="shape shape--5"> <img src="user_layout/images/posibilities/shape-line-5.svg" alt="shape-line-5"> </span>
        <div class="section__head text-center">
        ...
        <div class="posibilities--inner">
            <div class="posibilities--card">
                <div class="posibilities--card__head">
                    <div class="posibilities--card__head-icon">
                        <img src="user_layout/images/posibilities/care.svg" alt="care">
                    </div>
            ...
            <div class="posibilities--card">
                <div class="posibilities--card__head">
                    <div class="posibilities--card__head-icon">
                        <img src="user_layout/images/posibilities/schedule.svg" alt="care">
                    </div>
                    <div class="posibilities--card__head-title">
            ...
            <div class="posibilities--card">
                <div class="posibilities--card__head">
                    <div class="posibilities--card__head-icon">
                        <img src="user_layout/images/posibilities/earn-money.svg" alt="care">
                    </div>
                    <div class="posibilities--card__head-title">
                        <h3>Earn Money</h3>
                    </div>
            ...
            <div class="posibilities--card">
                <div class="posibilities--card__head">
                    <div class="posibilities--card__head-icon">
                        <img src="user_layout/images/posibilities/graduation.svg" alt="care">
                    </div>
                    <div class="posibilities--card__head-title">
    ...
    <section class="small_box_section">
        <span class="shape-4"> <img src="user_layout/images/box-icons/shape-l-8.svg" alt=""> </span>
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="small_box_section--card">
                        <div class="small_box_section--card__icon">
                            <img src="user_layout/images/box-icons/teaching.svg" alt="teaching">
                        </div>
                ...
                <div class="col">
                    <div class="small_box_section--card">
                        <div class="small_box_section--card__icon">
                            <img src="user_layout/images/box-icons/elearning.svg" alt="elearning">
                        </div>
                ...
                <div class="col">
                    <div class="small_box_section--card">
                        <div class="small_box_section--card__icon">
                            <img src="user_layout/images/box-icons/profile.svg" alt="profile">
                        </div>
                ...
                <div class="col">
                    <div class="small_box_section--card">
                        <div class="small_box_section--card__icon">
                            <img src="user_layout/images/box-icons/sell.svg" alt="sell">
                        </div>
                ...
                <div class="col">
                    <div class="small_box_section--card">
                        <div class="small_box_section--card__icon">
                            <img src="user_layout/images/box-icons/custom-live.svg" alt="custom-live.svg">
                        </div>
