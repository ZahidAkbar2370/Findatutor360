...
@section('user_layout')
    ...
    <section class="photGallery">
        <img class="img-big" src="user_layout/images/photo-gallery-desk.png" alt="photo-gallery-desk.png">
        <img class="img-sm" src="user_layout/images/photo-gallery-sm.png" alt="photo-gallery-smg">
    ...
    <section class="box_section box_section--tutor">
        <span class="shape shape--5"> <img src="user_layout/images/box-icons/shape-l-1.svg" alt=""> </span>
        <span class="shape shape--6"> <img src="user_layout/images/box-icons/shape-l-2.svg" alt=""> </span>
        <span class="shape shape--7"> <img src="user_layout/images/box-icons/shape-l-3.svg" alt=""> </span>
        <span class="shape shape--8"> <img src="user_layout/images/box-icons/shape-l-4.svg" alt=""> </span>
        <span class="shape shape--9"> <img src="user_layout/images/box-icons/shape-l-5.svg" alt=""> </span>
        <span class="shape shape--10"> <img src="user_layout/images/box-icons/shape-l-6.svg" alt=""> </span>
        <span class="shape shape--11"> <img src="user_layout/images/box-icons/shape-l-7.svg" alt=""> </span>
        <span class="shape shape--12"> <img src="user_layout/images/box-icons/shape-l-10.svg" alt=""> </span>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="section__head text-center">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="box_section--card">
                        <div class="box_section--card__icon">
                            <img src="user_layout/images/inspire-student.svg" alt="inspire-student">
                        </div>
                        <div class="box_section--card__title">
    ...
    <section class="small_box_section">
        <span class="shape-2"> <img src="user_layout/images/box-icons/shape-l-8.svg" alt=""> </span>
        <span class="shape-3"> <img src="user_layout/images/box-icons/shape-l-9.svg" alt=""> </span>
        <div class="container-fluid">
