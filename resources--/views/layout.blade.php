...
<html lang="en">
  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="public/assets/frontend/images/logo.png" alt=""></a></div>
            <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i></div>
          </div>
          <div class="left-header col horizontal-wrapper ps-0">
            <ul class="horizontal-menu">
              <li class="mega-menu outside"><!-- <a class="nav-link" href="#!"><i data-feather="layers"></i><span style="margin-left:5px">Bonus Ui</span></a> -->
            ...
            <ul class="nav-menus">
              ...
              <li class="cart-nav onhover-dropdown">
                ...
                <ul class="cart-dropdown onhover-show-div">
                  ...
                  <li class="mt-0">
                    <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="../public/assets/images/ecommerce/01.jpg" alt="">
                  ...
                  <li class="mt-0">
                    <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="../public/assets/images/ecommerce/03.jpg" alt="">
                      <div class="media-body"><span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                        <p>Yellow(#fcb102)</p>
                        <div class="qty-box">
                          <div class="input-group"><span class="input-group-prepend">
              ...
              <li class="profile-nav onhover-dropdown p-0 me-0">
                <div class="media profile-media"><img class="b-r-10" src="../public/assets/images/dashboard/profile.jpg" alt="">
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper">
          <div>
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="../public/assets/images/logo/logo.png" alt=""><img class="img-fluid for-dark" src="../public/assets/images/logo/logo_dark.png" alt=""></a>
              ...
              <div id="sidebar-menu">
                ...
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-tachometer"></i><span style="margin-left:5px">Dashboard</span></a>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-shopping-cart"></i><span style="margin-left:5px">Bookings</span></a>
                    <!-- <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul> -->
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-gift"></i><span style="margin-left:5px">Offers Management</span></a>
                    <!-- <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul> -->
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-search"></i><span style="margin-left:5px">Find Course</span></a>
                    <!-- <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul> -->
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i  class="fa fa-envelope"></i><span style="margin-left:5px">Messages</span></a>
                    <!-- <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul> -->
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i  class="fa fa-star"></i><span style="margin-left:5px">Reviews</span></a>
                    <!-- <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul> -->
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-user"></i><span style="margin-left:5px">Profile Management</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="student-my-profile">My Profile</a></li>
                      <!-- <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li> -->
                    </ul>
                  </li>

                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-credit-card"></i><span style="margin-left:5px">Payment Management</span></a>
                    <!-- <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul> -->
                ...
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="tutor-dashboard"><i class="fa fa-tachometer"></i><span style="margin-left:5px">Dashboard</span></a>
                  </li>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-book"></i><span style="margin-left:5px">Buy Books</span></a>
                    <!-- <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul> -->
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-shopping-cart"></i><span style="margin-left:5px">Sell Books</span></a>
                    <!-- <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul> -->
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-user"></i><span style="margin-left:5px">Profile Management</span></a>
                    <ul class="sidebar-submenu">
                      <li><a  href="tutor-add-course">Add Course</a></li>
                      <li><a  href="tutor-all-courses">All Courses</a></li>
                      <li><a  href="tutor-my-profile">My Profile</a></li>
                    </ul>
                  </li>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-question-circle"></i><span style="margin-left:5px">Dispute Management</span></a>
                    <!-- <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul> -->
                ...
                @elseif(Auth::user()->role=="institute")
                  ...
                  <li class="sidebar-list">
                    <label class="badge badge-success"></label><a class="sidebar-link sidebar-title" href="#"><i class="fa fa-tachometer"></i><span class="lan-3">Dashboard</span></a>
                    <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-registered "></i><span style="margin-left:5px">Enrollment Management</span></a>
                    <!-- <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul> -->
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-certificate"></i><span style="margin-left:5px">Batch Management</span></a>
                    <ul class="sidebar-submenu">
                      <li><a  href="institute-add-batch">Add Batch</a></li>
                      <li><a href="institute-all-batch">View Batch</a></li>
                    </ul>
                  </li>


                   <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fas fa-chalkboard-teacher"></i><span style="margin-left:5px">Tutors</span></a>
                    <!-- <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul> -->
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-shopping-cart"></i><span style="margin-left:5px">Buy Books</span></a>
                    <!-- <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="index.html">Default</a></li>
                      <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li>
                    </ul> -->
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-user"></i><span style="margin-left:5px">Profile Mnagement</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="institute-my-profile">My Profile</a></li>
                      <!-- <li><a class="lan-5" href="dashboard-02.html">Ecommerce</a></li> -->
                    </ul>
                  </li>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 footer-copyright text-center">
                <p class="mb-0">Copyright 2020 © Findatutor360</p>
              </div>
            </div>
          </div>
        </footer> -->
    ...
    <script src="public/assets/js/datatable/datatables/datatable.custom.js"></script>
    <!-- login js-->
    <!-- Plugin used-->
  </body>
</html>